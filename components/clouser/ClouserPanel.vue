  ...
  <div class="w-80 border-l border-white/5 bg-surface/50 flex flex-col h-full overflow-y-auto">
    ...
    <div class="p-4 border-b border-white/5 bg-surface sticky top-0 z-10">
      <div class="flex items-center gap-2 text-primary font-bold">
        <Bot class="w-5 h-5" />
        <h2>AI Sales Clouser</h2>
      </div>
      <p class="text-xs text-text-secondary mt-1">Analyzing conversation in real-time</p>
    </div>

    <div class="p-4 space-y-6 flex-1">
      <!-- Lead Temperature -->
      <div class="space-y-3">
        <h3 class="text-xs font-semibold text-text-secondary uppercase tracking-wider">Lead Temperature</h3>
      ...
      <div class="space-y-3">
        <div class="flex items-center justify-between">
          <h3 class="text-xs font-semibold text-text-secondary uppercase tracking-wider">Suggested Replies</h3>
          <button class="text-primary hover:text-primary-accent p-1" title="Refresh suggestions">
      ...
      <!-- Objection Insights -->
      <div class="space-y-3">
        <h3 class="text-xs font-semibold text-text-secondary uppercase tracking-wider">Objection Insights</h3>
        <div class="space-y-2">
      ...
      <!-- Next Actions -->
      <div class="space-y-3">
        <h3 class="text-xs font-semibold text-text-secondary uppercase tracking-wider">Recommended Actions</h3>
        <ul class="space-y-2">
